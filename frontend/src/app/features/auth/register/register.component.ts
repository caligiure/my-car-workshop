...
@Component({
  ...
  `,
  styles: [`
    .register-card { background: rgba(255, 255, 255, 0.85); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.4); padding: 2rem; border-radius: 8px; box-shadow: 0 8px 32px rgba(0,0,0,0.2); }
